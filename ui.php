...
yourls_html_head('html_title', 'ZHMAK!nu');
...
// Part to be executed when no form has been submitted
		...
		<p><label>Password (optional): <input type="text" class="text" name="pass" value="" /></label></p>
		...
		<p>Do not fill this field: <input type="text"id="nameprev"  name="nameprev" value="" /></p>
		</form>	
HTML;
