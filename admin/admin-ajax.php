...
switch( $action ) {
	...
	case 'add':
		...
		$return = yourls_add_new_link( $_REQUEST['url'], $_REQUEST['keyword'],'', $_REQUEST['pass'] );
	...
	case 'edit_save':
		...
		$return = yourls_edit_link( $_REQUEST['url'], $_REQUEST['keyword'], $_REQUEST['newkeyword'], $_REQUEST['title'], $_REQUEST['pass'] );
		echo json_encode($return);
		break;
